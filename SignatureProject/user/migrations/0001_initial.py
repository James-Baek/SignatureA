# Generated by Django 2.1.4 on 2019-01-16 09:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nname', models.CharField(max_length=45, unique=True, verbose_name='닉네임')),
                ...
                ('artist_id', models.CharField(max_length=32, unique=True, verbose_name='아티스트 ID')),
                ('artist_name', models.CharField(max_length=100, verbose_name='아티스트 이름')),
                ('artist_opendate', models.DateField(verbose_name='데뷔일')),
                ('artist_company', models.CharField(blank=True, default='none', max_length=32, verbose_name='소속 기업 ID')),
                ('company_id', models.CharField(blank=True, default='none', max_length=32, unique=True, verbose_name='기업 ID')),
                ('company_name', models.CharField(blank=True, default='none', max_length=45, verbose_name='기업명')),
