...
console.log("submit recording of a Song catch: ");
...
var peer = fabric_client.newPeer('grpc://210.107.78.153:7051');
channel.addPeer(peer);
var order = fabric_client.newOrderer('grpc://210.107.78.153:7050')
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    if (isProposalGood) {
        ...
        event_hub.setPeerAddr('grpc://210.107.78.153:7053');
