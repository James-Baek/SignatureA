...
#     profile = models.FileField('프로필이미지',max_length=100,null=True,blank=True,upload_to='profile/')
...
#     faceph = models.ImageField('아티스트 사진',max_length=50,null=True,blank=True,upload_to='artist/')
